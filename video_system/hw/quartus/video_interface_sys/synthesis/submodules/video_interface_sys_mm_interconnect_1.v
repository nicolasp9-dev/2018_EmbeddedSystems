// video_interface_sys_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module video_interface_sys_mm_interconnect_1 (
	...
	video_interface_sys_mm_interconnect_1_router router (
	...
	video_interface_sys_mm_interconnect_1_router_001 router_001 (
	...
	video_interface_sys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	video_interface_sys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	video_interface_sys_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	video_interface_sys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
